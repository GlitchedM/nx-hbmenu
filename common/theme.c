...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeLight = (theme_t) {
        ...
        .frontWaveColor = MakeColor(150, 194, 255, 255),
        .middleWaveColor = MakeColor(0, 140, 255, 255),
        .backWaveColor = MakeColor(0, 0, 200, 255),
        .backgroundColor = MakeColor(200, 200, 200, 255),
        .highlightColor = MakeColor(1, 238, 255, 255),
        .highlightGradientEdgeColor = MakeColor(174, 97, 255, 255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(0, 0, 170, 255),
    ...
    theme_t themeDark = (theme_t) {
        ...
        .attentionTextColor = MakeColor(255, 152, 0, 255),
        .frontWaveColor = MakeColor(6, 0, 100, 255),
        .middleWaveColor = MakeColor(83, 169, 255, 255),
        .backWaveColor = MakeColor(0, 0, 160, 255),
        .backgroundColor = MakeColor(1, 40, 105, 255),
        .highlightColor = MakeColor(1, 238, 255, 255),
        .highlightGradientEdgeColor = MakeColor(174, 97, 255, 255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(200, 200, 220, 255),
        .borderTextColor = MakeColor(0, 0, 110, 255),
        .progressBarColor = MakeColor(0, 224, 0, 255),
        .enableWaveBlending = 0,
        .buttonAText = "\uE0A0",
        .buttonBText = "\uE0A1",
