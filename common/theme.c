...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeLight = (theme_t) {
        .textColor = MakeColor(10, 0, 255, 255),
        .attentionTextColor = MakeColor(255, 0, 0, 255),
        .frontWaveColor = MakeColor(6, 0, 255, 255),
        .middleWaveColor = MakeColor(0, 109, 255, 255),
        .backWaveColor = MakeColor(1, 198, 255, 255),
        ...
        .borderColor = MakeColor(233,236,241,255),
        .borderTextColor = MakeColor(50,50,50,255),
    ...
    theme_t themeDark = (theme_t) {
        ...
        .middleWaveColor = MakeColor(0, 109, 255, 255),
        .backWaveColor = MakeColor(1, 198, 255, 255),
        .backgroundColor = MakeColor(17, 15, 100, 255),
        .highlightColor = MakeColor(1, 204, 255, 255),
        .highlightGradientEdgeColor = MakeColor(102,240,255,255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(110,150,200,255),
        .borderTextColor = MakeColor(200,200,200,255),
        .progressBarColor = MakeColor(0,224,0,255),
        .enableWaveBlending = 0,
        .buttonAText = "\uE0A0",
        .buttonBText = "\uE0A1",
