...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeLight = (theme_t) {
        ...
        .borderTextColor = MakeColor(200, 200, 230, 255),
    ...
    theme_t themeDark = (theme_t) {
        .textColor = MakeColor(200, 255, 255, 255),
        .attentionTextColor = MakeColor(255, 87, 34, 255),
        .frontWaveColor = MakeColor(0, 100, 255, 255),
        .middleWaveColor = MakeColor(0, 0, 255, 255),
        .backWaveColor = MakeColor(0, 180, 200, 255),
        .backgroundColor = MakeColor(10, 20, 50, 255),
        .highlightColor = MakeColor(0, 0, 130, 255),
        .highlightGradientEdgeColor = MakeColor(0, 230, 255, 255),
        .separatorColor = MakeColor(219, 218, 219, 255),
        .borderColor = MakeColor(10, 20, 50, 255),
        .borderTextColor = MakeColor(200, 255, 255, 255),
        .progressBarColor = MakeColor(0 , 224, 0, 255),
        .enableWaveBlending = 0,
        .buttonAText = "\uE0A0",
        .buttonBText = "\uE0A1",
