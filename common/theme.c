...
void themeStartup(ThemePreset preset) {
    ...
    theme_t themeLight = (theme_t) {
        .textColor = MakeColor(0, 0, 110 , 255),
        .attentionTextColor = MakeColor(255, 118, 0 , 255),
        .frontWaveColor = MakeColor(0, 140, 200 , 255),
        .middleWaveColor = MakeColor(50, 120, 255 , 255),
        .backWaveColor = MakeColor(0, 0, 200 , 255),
        .backgroundColor = MakeColor(220, 220, 255 , 255),
        .highlightColor = MakeColor(0, 0, 150 , 255),
        .highlightGradientEdgeColor = MakeColor(0, 230, 255 , 255),
        .separatorColor = MakeColor(220, 220, 255 , 25),
        .borderColor = MakeColor(10, 20, 50 , 255),
        .borderTextColor = MakeColor(220, 220, 255 , 255),
    ...
    theme_t themeDark = (theme_t) {
        .textColor = MakeColor(220, 220, 255 , 255),
        .attentionTextColor = MakeColor(255, 200, 0 , 255),
        .frontWaveColor = MakeColor(0, 100, 255 , 255),
        .middleWaveColor = MakeColor(0, 0, 255 , 255),
        .backWaveColor = MakeColor(50, 180, 255 , 255),
        .backgroundColor = MakeColor(0, 20 ,40 , 255),
        .highlightGradientEdgeColor = MakeColor(100, 200, 255 , 255),
        .separatorColor = MakeColor(220, 220, 255 , 255),
        .borderColor = MakeColor(0, 0, 100 , 255),
        .borderTextColor = MakeColor(220, 220, 255 , 255),
        .progressBarColor = MakeColor(0 , 224, 0 , 255),
        .enableWaveBlending = 0,
        .buttonAText = "\uE0A0",
